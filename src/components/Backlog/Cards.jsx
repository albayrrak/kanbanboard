...
import { addBacklog } from "../../features/taskSlice";

export default function Cards() {
    let cards = useSelector((state) => state.task.backlog.cards); // Reduxtan gelen backlog state
    cards = JSON.parse(localStorage.getItem("Backlog"));
